...
export function normalizePHU(raw: RawPHU, index: number): NormalizedPHU {
  ...
  return {
    ...
    phone_alt: loc.phone_alt || '',
    toll_free: loc.toll_free || ca.toll_free || '',
    fax: loc.fax || '',
    fax_animal_exposure: loc.fax_animal_exposure || '',
    after_hours: loc.after_hours || '',
    after_hours_alt: loc.after_hours_alt || '',
    after_hours_toll_free: loc.after_hours_toll_free || '',
    after_hours_note: loc.after_hours_note || '',
