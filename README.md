...
For this project we started with three data files the ontario_public_health_units.json scraped from phdapps.health.gov.on.ca and Ontario_municipalities_EN.json and Ontario_municipalities_FR.json municipality data derived from this data set. (`https://github.com/drenton/PHU-locator/commit/50f6db475d2691db184e5543dd449f48f542bb5a`, `Data folder`). 
